...
void fitQDC_1234_conv() {
    ...
    h_q1->SetTitle("QDC Trigger S1-2-3-4, Segnale 1;QDC;#frac{dN}{d QDC}");
    h_q1->Draw("E");
    h_q1->Draw("HIST SAME");
    landau_q1->Draw("same");
    c1_conv->SetGrid();
    ...
    h_q2->SetTitle("QDC Trigger S1-2-3-4, Segnale 2;QDC;#frac{dN}{d QDC}");
    h_q2->Draw("E");
    h_q2->Draw("HIST SAME");
    landau_q2->Draw("same");
    c2_conv->SetGrid();
    ...
    h_q3->SetTitle("QDC Trigger S1-2-3-4, Segnale 3;QDC;#frac{dN}{d QDC}");
    h_q3->Draw("E");
    h_q3->Draw("HIST SAME");
    landau_q3->Draw("same");
    c3_conv->SetGrid();
    ...
    h_q4->SetTitle("QDC Trigger S1-2-3-4, Segnale 4;QDC;#frac{dN}{d QDC}");
    h_q4->Draw("E");
    h_q4->Draw("HIST SAME");
    landau_q4->Draw("same");
    c4_conv->SetGrid();
