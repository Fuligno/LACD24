...
void fitQDC_1234_conv() {
    ...
    TF1 *landau_gauss_q1 = new TF1("landau_gauss_q1", landauGaussConvolution, xmin_fit, 3000., 4);
    TF1 *landau_gauss_q2 = new TF1("landau_gauss_q2", landauGaussConvolution, xmin_fit, 3000., 4);
    ...
    landau_gauss_q2->SetParameters(initWidth, 900., initArea, initSigma);
