...
void fitTDC_3_gaussian() {
    ...
    // Parametri iniziali
    double cost1 = 1000, cost2 = 3000, cost3 = 9000;
    double mu = 1100.0;
    double sigma1 = 80.0, sigma2 = 60.0, sigma3 = 20.0;
    ...
    tgauss_t4->SetParameters(cost1, cost2, cost3, mu-150., sigma1, sigma2, sigma3);

    // Set histogram colors and transparency
    h_t1->SetLineColor(kRed-1.);
    h_t1->SetFillColorAlpha(kRed-2., 0.2);
    h_t1->SetLineWidth(2);

    h_t2->SetLineColor(kGreen-1.);
    h_t2->SetFillColorAlpha(kGreen-2., 0.2);
    h_t2->SetLineWidth(2);

    h_t3->SetLineColor(kCyan-1.);
    h_t3->SetFillColorAlpha(kCyan-2., 0.2);
    h_t3->SetLineWidth(2);

    h_t4->SetLineColor(kViolet-1.);
    h_t4->SetFillColorAlpha(kViolet-2., 0.2);
    h_t4->SetLineWidth(2);
    ...
    c_all->SetGrid();
    h_t3->SetTitle("Fit TDC coincidenza a 4;ch;Conteggi");
    h_t3->Draw("HIST");
    h_t1->Draw("HIST same");
    h_t2->Draw("HIST same");
    h_t4->Draw("HIST same");
    c_all->Update();
    c_all->SaveAs("../Dati/TDC/TDC_3/TDC_all.png");
    ...
    gauss_t1->Draw("same");
    c1_gauss->Update();
    c1_gauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel0_Gauss.png");
    ...
    dgauss_t1->Draw("same");
    c1_dgauss->Update();
    c1_dgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel0_doubleGauss.png");
    ...
    tgauss_t1->Draw("same");
    c1_tgauss->Update();
    c1_tgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel0_tripleGauss.png");
    ...
    gauss_t2->Draw("same");
    c2_gauss->Update();
    c2_gauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel1_Gauss.png");
    ...
    dgauss_t2->Draw("same");
    c2_dgauss->Update();
    c2_dgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel1_doubleGauss.png");
    ...
    tgauss_t2->Draw("same");
    c2_tgauss->Update();
    c2_tgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel1_tripleGauss.png"); 
    ...
    gauss_t3->Draw("same");
    c3_gauss->Update();
    c3_gauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel2_Gauss.png");
    ...
    dgauss_t3->Draw("same");
    c3_dgauss->Update();
    c3_dgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel2_doubleGauss.png");
    ...
    tgauss_t3->Draw("same");
    c3_tgauss->Update();
    c3_tgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel2_tripleGauss.png"); */
    ...
    gauss_t4->Draw("same");
    c4_gauss->Update();
    c4_gauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel3_Gauss.png");
    ...
    dgauss_t4->Draw("same");
    c4_dgauss->Update();
    c4_dgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel3_doubleGauss.png");
    ...
    tgauss_t4->Draw("same");
    c4_tgauss->Update();
    c4_tgauss->SaveAs("../Dati/TDC/TDC_3/TDC_Channel3_tripleGauss.png");
