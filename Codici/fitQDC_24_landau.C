...
void fitQDC_24_landau() {
    ...
    h_q1->SetLineColor(kRed+2.);
    h_q1->SetFillColorAlpha(kRed+1., 0.2);
    h_q1->SetLineWidth(2);

    h_q2->SetLineColor(kGreen+2.);
    h_q2->SetFillColorAlpha(kGreen+1., 0.2);
    h_q2->SetLineWidth(2);

    h_q3->SetLineColor(kCyan+2.);
    h_q3->SetFillColorAlpha(kCyan+1., 0.2);
    h_q3->SetLineWidth(2);

    h_q4->SetLineColor(kViolet+2.);
    h_q4->SetFillColorAlpha(kViolet+1., 0.2);
    h_q4->SetLineWidth(2);
