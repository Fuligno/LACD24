...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    TCanvas *c_all = new TCanvas("QDC con trigger S1-2-3-4", "QDC con trigger S1-2-3-4", 1500, 1800);
    c_all->SetGrid();
    h_q2->SetTitle("QDC con trigger S1-2-3-4;QDC;#frac{dN}{d QDC}");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
   // Definisce Landau per fit
    ...
    landau_q2->SetParameters(500., 850., sigmaL);
    ...
    h_q1->SetTitle("Trigger S1-2-3-4, Segnale 1;QDC;#frac{dN}{d QDC}");
    h_q1->Draw("E");
    h_q1->Draw("HIST SAME");
    landau_q1->Draw("same");
    c1_landau->SetGrid();
    ...
    h_q2->SetTitle("Trigger S1-2-3-4, Segnale 2;QDC;#frac{dN}{d QDC}");
    h_q2->Draw("E");
    h_q2->Draw("HIST SAME");
    landau_q2->Draw("same");
    c2_landau->SetGrid();
    ...
    h_q3->SetTitle("Trigger S1-2-3-4, Segnale 3;QDC;#frac{dN}{d QDC}");
    h_q3->Draw("E");
    h_q3->Draw("HIST SAME");
    landau_q3->Draw("same");
    c3_landau->SetGrid();
    ...
    h_q4->SetTitle("Trigger S1-2-3-4, Segnale 4;QDC;#frac{dN}{d QDC}");
    h_q4->Draw("E");
    h_q4->Draw("HIST SAME");
    landau_q4->Draw("same");
    c4_landau->SetGrid();
...
// RESIDUI
 ...
 vector<double> sigma_res1, sigma_res2, sigma_res3, sigma_res4;		// vettore che contiene gli errori sui residui
    ...
    TCanvas *c_residui = new TCanvas("c_residui", "QDC Trigger S1-2-3-4, Grafico dei Residui", 1200, 800);
...
c_histores->SetTitle("QDC Trigger S1-2-3-4, Istogramma dei Pull");
