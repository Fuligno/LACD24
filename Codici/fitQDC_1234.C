...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    c_all->SetGrid();
    h_q1->SetTitle("QDC con trigger S1-2-3-4;QDC;#frac{dN}{d QDC}");

    h_q1->GetYaxis()->SetRangeUser(xmin, 5000.);
    h_q1->Draw("E");    // Draw error bars and histogram
    h_q1->Draw("HIST same"); // Draw histogram lines on top

    h_q2->Draw("E same");    // Draw error bars and histogram
