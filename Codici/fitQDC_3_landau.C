...
// RESIDUI
 ...
 vector<double> sigma_res1, sigma_res2, sigma_res3, sigma_res4;		// vettore che contiene gli errori sui residui
    ...
    // Residui per q1
    TCanvas *c_residui1 = new TCanvas("c_residui1", "QDC Trigger S3, Grafico dei Residui segnale 1", 1200, 800);
    c_residui1->cd();
    c_residui1->SetGrid();
...
// Residui per q2
    TCanvas *c_residui2 = new TCanvas("c_residui2", "QDC Trigger S3, Grafico dei Residui segnale 2", 1200, 800);
    c_residui2->cd();
    c_residui2->SetGrid();
    ...
    // Residui per q3
    TCanvas *c_residui3 = new TCanvas("c_residui3", "QDC Trigger S3, Grafico dei Residui segnale 3", 1200, 800);
    c_residui3->cd();
    c_residui3->SetGrid();
    ...
    // Residui per q4
    TCanvas *c_residui4 = new TCanvas("c_residui4", "QDC Trigger S3, Grafico dei Residui segnale 4", 1200, 800);
    c_residui4->cd();
    c_residui4->SetGrid();
