...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    c_all->Update();
    c_all->SaveAs("../Dati/QDC/QDC_3/QDC_all.pdf");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
   // Definisce Landau per fit
    ...
    c1_landau->SetGrid();
    c1_landau->Update();
    c1_landau->SaveAs("../Dati/QDC/QDC_3/QDC_Channel0_Landau.pdf");
    ...
    c2_landau->SetGrid();
    c2_landau->Update();
    c2_landau->SaveAs("../Dati/QDC/QDC_3/QDC_Channel1_Landau.pdf");
    ...
    c3_landau->SetGrid();
    c3_landau->Update();
    c3_landau->SaveAs("../Dati/QDC/QDC_3/QDC_Channel2_Landau.pdf");
    ...
    c4_landau->SetGrid();
    c4_landau->Update();
    c4_landau->SaveAs("../Dati/QDC/QDC_3/QDC_Channel3_Landau.pdf");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Disegna istogrammi + fit
    TCanvas *c1_landau_gauss = new TCanvas("c1_landau_gauss", "QDC Channel 0 Landau + Gauss", 1500, 1200);
    h_q1->SetTitle("QDC Channel 0 Landau + Gauss;QDC;conteggi");
    h_q1->Draw("HIST");
    landau_gauss_q1->Draw("same");
    c1_landau_gauss->SetGrid();
    c1_landau_gauss->Update();
    c1_landau_gauss->SaveAs("../Dati/QDC/QDC_3/QDC_Channel0_Landau_Gauss.pdf");

    TCanvas *c2_landau_gauss = new TCanvas("c2_landau_gauss", "QDC Channel 1 Landau + Gauss", 1500, 1200);
    h_q2->SetTitle("QDC Channel 1 Landau + Gauss;QDC;conteggi");
    h_q2->Draw("HIST");
    landau_gauss_q2->Draw("same");
    c2_landau_gauss->SetGrid();
    c2_landau_gauss->Update();
    c2_landau_gauss->SaveAs("../Dati/QDC/QDC_3/QDC_Channel1_Landau_Gauss.pdf");

    TCanvas *c3_landau_gauss = new TCanvas("c3_landau_gauss", "QDC Channel 2 Landau + Gauss", 1500, 1200);
    h_q3->SetTitle("QDC Channel 2 Landau + Gauss;QDC;conteggi");
    h_q3->Draw("HIST");
    landau_gauss_q3->Draw("same");
    c3_landau_gauss->SetGrid();
    c3_landau_gauss->Update();
    c3_landau_gauss->SaveAs("../Dati/QDC/QDC_3/QDC_Channel2_Landau_Gauss.pdf");

    TCanvas *c4_landau_gauss = new TCanvas("c4_landau_gauss", "QDC Channel 3 Landau + Gauss", 1500, 1200);
    h_q4->SetTitle("QDC Channel 3 Landau + Gauss;QDC;conteggi");
    h_q4->Draw("HIST");
    landau_gauss_q4->Draw("same");
    c4_landau_gauss->SetGrid();
    c4_landau_gauss->Update();
    c4_landau_gauss->SaveAs("../Dati/QDC/QDC_3/QDC_Channel3_Landau_Gauss.pdf");
...
c_histores->Update();
c_histores->SaveAs("../Dati/QDC/QDC_3/Residuals_Histograms.pdf");
c_histores->SaveAs("../Dati/QDC/QDC_3/Residuals_Histograms.pdf");
