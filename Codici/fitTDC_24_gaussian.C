...
void fitTDC_24_gaussian() {
    ...
    // Parametri iniziali
    double cost1 = 2000, cost2 = 5000, cost3 = 9000;
    double mu = 1000.0;
    ...
    tgauss_t1->SetParameters(cost1, cost2, cost3, mu+100., sigma1, sigma2, sigma3);
    tgauss_t2->SetParameters(cost1, cost2, cost3, mu-10., sigma1, sigma2, sigma3);
    tgauss_t3->SetParameters(cost1, cost2, cost3, mu+80., sigma1, sigma2, sigma3);
    tgauss_t4->SetParameters(cost1, cost2, cost3, mu-200., sigma1, sigma2, sigma3);
    ...
    c_all->SetGrid();
    h_t2->SetTitle("Fit TDC coincidenza a 4;ch;Conteggi");
    h_t2->Draw("HIST");
    h_t1->Draw("HIST same");
    h_t3->Draw("HIST same");
    h_t4->Draw("HIST same");
    c_all->Update();
    c_all->SaveAs("../Dati/TDC/TDC_24/TDC_all.png");

    // Disegna istogrammi + fit
    TCanvas *c1_gauss = new TCanvas("c1_gauss", "TDC Channel 0 Gauss", 1500, 1800);
    c1_gauss->SetGrid();
    h_t1->SetTitle("Fit TDC (gauss) CH1;ch;Conteggi");
    h_t1->Fit("gauss_t1");
    h_t1->Draw("HIST");
    gauss_t1->Draw("same");
    c1_gauss->Update();
    c1_gauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel0_Gauss.png");

    TCanvas *c1_dgauss = new TCanvas("c1_dgauss", "TDC Channel 0 DoubleGauss", 1500, 1800);
    c1_dgauss->SetGrid();
    h_t1->SetTitle("Fit TDC (doppio gauss) CH1;ch;Conteggi");
    h_t1->Fit("dgauss_t1");
    h_t1->Draw("HIST");
    dgauss_t1->Draw("same");
    c1_dgauss->Update();
    c1_dgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel0_doubleGauss.png");

    TCanvas *c1_tgauss = new TCanvas("c1_tgauss", "TDC Channel 0 TripleGauss", 1500, 1800);
    c1_tgauss->SetGrid();
    h_t1->SetTitle("Fit TDC (triplo gauss) CH1;ch;Conteggi");
    h_t1->Fit("tgauss_t1");
    h_t1->Draw("HIST");
    tgauss_t1->Draw("same");
    c1_tgauss->Update();
    c1_tgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel0_tripleGauss.png");
    ...
    gauss_t2->Draw("same");
    c2_gauss->Update();
    c2_gauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel1_Gauss.png");
    ...
    dgauss_t2->Draw("same");
    c2_dgauss->Update();
    c2_dgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel1_doubleGauss.png");
    ...
    tgauss_t2->Draw("same");
    c2_tgauss->Update();
    c2_tgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel1_tripleGauss.png"); */
    ...
    gauss_t3->Draw("same");
    c3_gauss->Update();
    c3_gauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel2_Gauss.png");
    ...
    dgauss_t3->Draw("same");
    c3_dgauss->Update();
    c3_dgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel2_doubleGauss.png");
    ...
    tgauss_t3->Draw("same");
    c3_tgauss->Update();
    c3_tgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel2_tripleGauss.png");
    ...
    gauss_t4->Draw("same");
    c4_gauss->Update();
    c4_gauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel3_Gauss.png");
    ...
    dgauss_t4->Draw("same");
    c4_dgauss->Update();
    c4_dgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel3_doubleGauss.png");
    ...
    tgauss_t4->Draw("same");
    c4_tgauss->Update();
    c4_tgauss->SaveAs("../Dati/TDC/TDC_24/TDC_Channel3_tripleGauss.png");

    ///////

    // Salva i risultati in un file ROOT
    TFile outFile("../Dati/TDC/TDC_24/DataTDC_24.root", "RECREATE");
